...
$vl_jwt_auth_table = $wpdb->prefix . 'vl_refresh_tokens';
...
$wpdb->query( "DROP TABLE IF EXISTS {$vl_jwt_auth_table}" ); // phpcs:ignore WordPress.DB.PreparedSQL.InterpolatedNotPrepared,WordPress.DB.DirectDatabaseQuery
