...
final class SessionListMetaBoxTest extends TestCase {
	...
	public function test_register_calls_add_meta_box_with_correct_post_type(): void {
		...
		( new SessionListMetaBox() )->register();

		self::assertCount( 1, $captured );
		self::assertSame( 'vl_lms_session_list', $captured[0][0] );
		self::assertSame( 'Сесії', $captured[0][1] );
		self::assertSame( 'vl_course', $captured[0][3] );
	}

	public function test_render_outputs_no_children_message_when_empty(): void {
		$box = new class() extends SessionListMetaBox {
